...
\section{Scans Analysis Overview}
...
\vspace{0.3cm} \noindent
On average the scanner was able to obtain a HTTP and or a HTTPS request 95\% of the time from the Tranco list of 1 million domains, shown in figure \ref{fig:domains_scan_status}.
...
%		\includesvg[width=0.75](TaskFlow.svg)
%		\def\svgscale{0.4}
        \scalebox{0.47}{\subimport{../images}{domains_not_scanned-status_pie.pdf_tex}}
		\caption{High Level Task Flow}
		\label{fig:task_flow}
	\end{center}
\end{figure}
...
%		\includesvg[width=0.75](TaskFlow.svg)
%		\def\svgscale{0.4}
        \scalebox{0.47}{\subimport{../images}{domains_not_scanned-cannot_retry_pie.pdf_tex}}
		\caption{High Level Task Flow}
		\label{fig:task_flow}
	\end{center}
\end{figure}
