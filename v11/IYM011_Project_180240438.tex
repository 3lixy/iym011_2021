...
\begin{figure}[t]
	\begin{center}
        \scalebox{0.90}{\subimport{../images}{STS_preload-overview.pdf_tex}}
...
\begin{figure}[t]
	\begin{center}
        \scalebox{0.90}{\subimport{../images}{STS_preload-preloaded-not_all_criteria_met.pdf_tex}}
...
\begin{figure}[t]
	\begin{center}
        \scalebox{0.90}{\subimport{../images}{misc_headers-STS_overview.pdf_tex}}
...
\begin{figure}[t]
	\begin{center}
        \scalebox{0.90}{\subimport{../images}{misc_headers-STS_max_age.pdf_tex}}
