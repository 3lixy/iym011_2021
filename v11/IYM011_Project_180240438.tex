...
\vspace{0.3cm} \noindent
\textbf{Chapter \ref{chap:sec_feat_primer} - Security Features Primer} provides a technical background of relevant technologies related to the security mechanisms to be analysed. The chosen security mechanisms to be analysed are given a brief overview along with any attacks they are designed to mitigate.

\vspace{0.3cm} \noindent
\textbf{Chapter \ref{chap:sec_feat_exist} - Why Security Features Exist} details the need for security mechanisms, focusing on those mentioned in Part I, including the following attacks: \textit{Cross Site Scripting (XSS)}, \textit{Supply Chain Attacks}, \textit{Clickjacking} and \textit{Entity in the Middle Attacks}.

\vspace{0.3cm} \noindent
\textbf{Chapter \ref{chap:data_acqusition} - Data Acquisition} discusses internet scanning, the issues to be aware of and how other similar research has captured their data. This part concludes with detailing how this project carried out the data capture.

\vspace{0.3cm} \noindent
\textbf{Chapter \ref{chap:analysis} - Security Mechanism Adoption Analysis} analyses the chosen security mechanisms described in Part I from the data captured, over a 16 month period from November 2020 to February 2022, as detailed in Part III.

\vspace{0.3cm} \noindent
\textbf{Chapter \ref{chap:conclusion} - Conclusions and Closing Remarks} brings the report to an end concluding that apart from TLS the other chosen security mechanism that are currently not deprecated are of relatively low usage and work needs to be done to improve this.
...
\vspace{0.3cm} \noindent
Appendix \textbf{TODO} details the TLS client capabilities of the Task Agent.
