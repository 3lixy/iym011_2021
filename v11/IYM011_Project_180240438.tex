...
\noindent
Figure \ref{fig:coop_overview} shows the usage of the COOP header and its directives \texttt{unsafe-none}, \texttt{same-origin-allow-popups} and \texttt{same-origin}. The usage of the COOP header almost double that of the CORP header and quadruple that of the COEP header in January 2022, but is still rather low.
