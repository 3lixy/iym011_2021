...
\vspace{0.3cm} \noindent
\textbf{Part V - Conclusions and Closing Remarks} brings the report to an end concluding that apart from TLS the other chosen security mechanism that are currently not deprecated are of relatively low usage and work needs to be done to improve this.
