...
\vspace{0.3cm} \noindent
\hyperref[chap:sec_feat_primer]{\textbf{Chapter \ref{chap:sec_feat_primer} - Security Features Primer}} provides a technical background of relevant technologies related to the security mechanisms to be analysed. The chosen security mechanisms to be analysed are given a brief overview along with any attacks they are designed to mitigate.
