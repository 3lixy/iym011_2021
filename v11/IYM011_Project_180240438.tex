...
%		\includesvg[width=0.75](TaskFlow.svg)
%		\def\svgscale{0.4}
        \subfloat[\centering Average percentage of task status]{\scalebox{0.80}{\subimport{../images}{domains_not_scanned-status_pie.pdf_tex}}}
        \subfloat[\centering Average percentage of task failure cause]{\scalebox{0.80}{\subimport{../images}{domains_not_scanned-cannot_retry_pie.pdf_tex}}}
